# Generated by Django 4.2.6 on 2024-02-24 02:14
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('books', models.ManyToManyField(to='librarian.books', verbose_name='图书')),
            ],
        ),
        migrations.CreateModel(
            name='Image',
            fields=[
                ...
                ('books', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='librarian.books', verbose_name='图书')),
            ],
        ),
        migrations.AddField(
            model_name='books',
            name='publisher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='librarian.publisher', verbose_name='出版社名称'),
        ),
        migrations.CreateModel(
            name='Author',
            fields=[
                ...
                ('books', models.ManyToManyField(related_name='author_book', to='librarian.books', verbose_name='图书')),
            ],
        ),
    ]
